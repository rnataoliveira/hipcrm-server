...
namespace server.Data.Migrations
{
    ...
    [Migration("20180615014116_PhysicalPersonAgreement")]
    partial class PhysicalPersonAgreement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.AgreementData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AgreementData");

                    b.HasDiscriminator<string>("Discriminator").HasValue("AgreementData");
                });
            ...
            modelBuilder.Entity("server.Models.Dependent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("server.Models.LegalPersonAgreement", b =>
                {
                    b.HasBaseType("server.Models.AgreementData");
            ...
            modelBuilder.Entity("server.Models.PhysicalPersonAgreement", b =>
                {
                    b.HasBaseType("server.Models.AgreementData");

                    b.Property<string>("Plan");

                    b.ToTable("PhysicalPersonAgreement");

                    b.HasDiscriminator().HasValue("PhysicalPersonAgreement");
                });
            ...
            modelBuilder.Entity("server.Models.Agreement", b =>
                {
                    b.HasOne("server.Models.AgreementData", "PersonalData")
                        .WithMany()
            ...
            modelBuilder.Entity("server.Models.Dependent", b =>
                {
                    b.HasOne("server.Models.PhysicalPersonAgreement", "Agreement")
                        .WithMany("Dependents")
                        .HasForeignKey("AgreementId");
                });
