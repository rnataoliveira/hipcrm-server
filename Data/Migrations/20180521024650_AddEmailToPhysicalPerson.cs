...
{
    public partial class AddEmailToPhysicalPerson : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "PersonalData",
                columns: new[] { "Id", "Discriminator", "BirthDate", "DocumentNumber", "Email", "FirstName", "GeneralRegistration", "MaritalState", "Sex", "Surname", "Address_City", "Address_Complement", "Address_Neighborhood", "Address_Number", "Address_State", "Address_Street", "Address_ZipCode", "CellPhone_AreaCode", "CellPhone_Number", "Phone_AreaCode", "Phone_Number" },
